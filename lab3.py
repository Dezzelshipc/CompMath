...
class Plotter:
    ...
    def calc_fin_diff_n(self):
        ...
        self.finite_differences[0] = self.calc_f_nodes()
    ...
    def calc_f_nodes(self):
        return [f(x) for x in self.nodes]
    ...
    def add_functionality(self):
        ...
        radio = RadioButtons(rax, ['Lagrange', 'Newton', 'NewtR1', 'NewtR2', 'F'], active=0)
